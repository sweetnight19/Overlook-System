...
void processarDades(Reg_estacions *reg_estacions, semaphore *sem_write, semaphore *sem_read, int *cerrar) {
    ...
    do {
        ...
        if (posicio_estacio < 0) {
            ...
            strcpy(estructura_estacions.estacions[estructura_estacions.num_estacions - 1].nom,
                   reg_estacions->nom_estacio);
            estructura_estacions.estacions[estructura_estacions.num_estacions - 1].num_lectures = 1;
            estructura_estacions.estacions[estructura_estacions.num_estacions -
                                           1].mitjana_estacions.temperatura = reg_estacions->temperatura;
            estructura_estacions.estacions[estructura_estacions.num_estacions -
                                           1].mitjana_estacions.humitat = reg_estacions->humitat;
            estructura_estacions.estacions[estructura_estacions.num_estacions -
                                           1].mitjana_estacions.pressio_atmos = reg_estacions->pressio_atmos;
            estructura_estacions.estacions[estructura_estacions.num_estacions -
                                           1].mitjana_estacions.precipitacio = reg_estacions->precipitacio;
        } else {

            estructura_estacions.estacions[posicio_estacio].mitjana_estacions.temperatura =
                    ((estructura_estacions.estacions[posicio_estacio].mitjana_estacions.temperatura *
                      estructura_estacions.estacions[posicio_estacio].num_lectures) + reg_estacions->temperatura) /
                    (estructura_estacions.estacions[posicio_estacio].num_lectures + 1);
            estructura_estacions.estacions[posicio_estacio].mitjana_estacions.humitat =
                    ((estructura_estacions.estacions[posicio_estacio].mitjana_estacions.humitat *
                      estructura_estacions.estacions[posicio_estacio].num_lectures) + reg_estacions->humitat) /
                    (estructura_estacions.estacions[posicio_estacio].num_lectures + 1);
            estructura_estacions.estacions[posicio_estacio].mitjana_estacions.pressio_atmos =
                    ((estructura_estacions.estacions[posicio_estacio].mitjana_estacions.pressio_atmos *
                      estructura_estacions.estacions[posicio_estacio].num_lectures) + reg_estacions->pressio_atmos) /
                    (estructura_estacions.estacions[posicio_estacio].num_lectures + 1);
            estructura_estacions.estacions[posicio_estacio].mitjana_estacions.precipitacio =
                    ((estructura_estacions.estacions[posicio_estacio].mitjana_estacions.precipitacio *
                      estructura_estacions.estacions[posicio_estacio].num_lectures) + reg_estacions->precipitacio) /
                    (estructura_estacions.estacions[posicio_estacio].num_lectures + 1);
